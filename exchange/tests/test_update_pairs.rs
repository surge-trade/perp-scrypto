...
#[test]
fn test_update_pairs_long_skew_funding_2_exceed_max_negative_skew() {
    let mut interface = get_setup();
    let base_resource = interface.resources.base_resource;
    ...
    assert_eq!(pair_details.pool_position.oi_short, amount_short_1);
    assert_eq!(pair_details.pool_position.funding_2_rate, pair_details_4.pool_position.funding_2_rate - decay + funding_2_rate_delta);
    ...
    assert_eq!(update.skew_abs_snap, skew_abs);
    assert_eq!(update.pnl_snap, pnl_snap);
    assert_eq!(update.funding_2_rate, pair_details_4.pool_position.funding_2_rate - decay + funding_2_rate_delta);
...
#[test]
fn test_update_pairs_long_skew_funding_2_exceed_max_positive_skew() {
    let mut interface = get_setup();
    let base_resource = interface.resources.base_resource;
...
#[test]
fn test_update_pairs_short_skew_funding_2_exceed_min_positive_skew() {
    let mut interface = get_setup();
    let base_resource = interface.resources.base_resource;
...
#[test]
fn test_update_pairs_short_skew_funding_2_exceed_min_negative_skew() {
    let mut interface = get_setup();
    let base_resource = interface.resources.base_resource;
