...
async def main():
    ...
    async with ClientSession(connector=TCPConnector(ssl=False)) as session:
        ...
        public_key_hash = ret.hash(public_key.value)
        initial_rule = f'{network_config["ed25519_virtual_badge"]}:[{public_key_hash.as_str()}]'

        #     5105478d7129ef4c381d76d9e1ebe4c80ef58c022b5b14183e744a64bdc6
        # abc79905478d7129ef4c381d76d9e1ebe4c80ef58c022b5b14183e744a64bdc6
        manifest = f'''
            CALL_METHOD
