        ...
        builder = builder.call_method(
            ...
            [ManifestBuilderValue.ARRAY_VALUE(ManifestBuilderValueKind.TUPLE_VALUE, [
                ManifestBuilderValue.TUPLE_VALUE([
                    ...
                    ManifestBuilderValue.DECIMAL_VALUE(Decimal('0.0001')), # pub funding_1: Decimal,
                    ManifestBuilderValue.DECIMAL_VALUE(Decimal('0.0001')),  # pub funding_2: Decimal,
                    ManifestBuilderValue.DECIMAL_VALUE(Decimal('0.0001')),  # pub funding_2_delta: Decimal,
                    ManifestBuilderValue.DECIMAL_VALUE(Decimal('0.0001')),  # pub funding_pool_0: Decimal,
                    ManifestBuilderValue.DECIMAL_VALUE(Decimal('0.0001')),  # pub funding_pool_1: Decimal,
                    ManifestBuilderValue.DECIMAL_VALUE(Decimal('0.0001')),  # pub funding_share: Decimal,
                    ManifestBuilderValue.DECIMAL_VALUE(Decimal('0.0001')),  # pub fee_0: Decimal,
                    ManifestBuilderValue.DECIMAL_VALUE(Decimal('0.0001'))  # pub fee_1: Decimal,
                ])
            ])]
        )
